...
BIMODAL = 0.62     # 활자 상자 안 픽셀 중 «가장 어둡거나 가장 밝은 20%» 의 몫.
                   # 글자는 잉크와 종이 둘뿐이라 양 끝에 몰리고, 사진은 중간이
                   # 두껍다. 이 아래면 그 상자는 활자가 아니라 그림으로 본다 —
...
def _bimodal(g, box):
    """상자 안 명도가 양 끝에 몰리나. 글자는 잉크·종이 둘뿐이다."""
    y1, y2, x1, x2 = box
